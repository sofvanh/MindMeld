      ...
      <div className="md:ml-64">
        <div className="px-4 max-w-screen-md mx-auto my-16">
          ...
          <div className="prose prose-stone max-w-none">
            ...
            <pre><code>totalConnections = 2 * N * averageQuality</code></pre>

            <h2 id="statement-scores">Statement Scores</h2>
            <p>User reactions are used to compute scores for each statement. These scores are a signal for how surprising the reactions were, given how users have reacted to other statements. Each statement will get three scores:</p>
            <ul>
            ...
            <h3>Consensus (user)</h3>
            <p>A user's vote is expected to differ from their out-group. When this expectation is violated, this is called consensus.</p>
            <p>A user's consensus score is equal to the fraction of their out-group they agreed with, weighted by the magnitude of the similarity of their vote profiles (highly dissimilar users count for more).</p>

            <h3>Divergence (user)</h3>
            <p>A user's vote is expected to align with their in-group. When this expectation is violated, this is called divergence.</p>
            <p>A user's divergence score is equal to the fraction of their in-group they disagreed with, weighted by the similarity of their vote profiles (highly similar users count for more).</p>
