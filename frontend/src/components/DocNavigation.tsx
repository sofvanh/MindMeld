...
const DocNavigation: React.FC<DocNavigationProps> = ({ sections }) => {
  ...
  return (
    <>
      ...
      <nav className="md:hidden w-full border-b border-stone-200 bg-white mb-8">
      ...
      <nav className="hidden md:block fixed left-0 top-16 w-64 h-[calc(100vh-4rem)] border-r border-stone-200 bg-white overflow-y-auto">
